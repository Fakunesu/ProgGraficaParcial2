...
Shader "Projector"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			o.Emission = ( ( color2 * tex2D( _TextureSample0, ( (mul( unity_Projector, float4( ase_vertex3Pos , 0.0 ) ).xyz).xy + ( _Time.y * _Speed ) ) ) ) * _Intensity ).rgb;
			o.Alpha = 1;
		}
...
/*ASEBEGIN
Version=18900
178;73;1313;600;1757.599;89.27935;1.3;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;3;-999.8362,457.7086;Inherit;False;Property;_Speed;Speed;2;0;Create;True;0;0;0;False;0;False;0.15;0.15;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;4;-152.8955,330.8673;Inherit;False;Property;_Intensity;Intensity;1;0;Create;True;0;0;0;False;0;False;1;1.74;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=EBB75298B3368EFA6019562887B15CF2F5A1B07F